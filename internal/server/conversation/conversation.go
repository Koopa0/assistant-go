...
func (s *ConversationService) ExportConversation(ctx context.Context, conversationID string) (*assistant.Conversation, error) {
	return s.assistant.GetConversation(ctx, conversationID)
}

// Helper methods

func (s *ConversationService) convertToResponse(conv *assistant.Conversation) ConversationResponse {
	// Extract metadata
	language := ""
	toolsUsed := []string{}
	satisfaction := 0.0
...
func (s *ConversationService) convertToDetailedResponse(conv *assistant.Conversation) ConversationDetailResponse {
...
func (s *ConversationService) getLastMessage(conv *assistant.Conversation) string {
...
func (s *ConversationService) getCategory(conv *assistant.Conversation) string {
	if conv.Metadata != nil {
...
func (s *ConversationService) extractTags(conv *assistant.Conversation) []string {
	tags := []string{}
	if conv.Metadata != nil {
...
func (s *ConversationService) getStatus(conv *assistant.Conversation) string {
	if conv.Metadata != nil {
...
func (s *ConversationService) containsKeywords(conv *assistant.Conversation, keywords []string) bool {
...
func (s *ConversationService) calculateInsights(conv *assistant.Conversation) ConversationInsights {
...
func (s *ConversationService) matchesSearch(conv *assistant.Conversation, search string) bool {
