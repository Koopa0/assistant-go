...
func (s *ChatService) ListConversations(ctx context.Context, userID string, limit, offset int) ([]*assistant.Conversation, error) {
	if userID == "" {
		userID = "api_user"
	}
...
func (s *ChatService) GetConversation(ctx context.Context, conversationID string) (*assistant.Conversation, error) {
