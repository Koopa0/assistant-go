...
// Memory Entry domain methods - DEPRECATED
// These methods are disabled as memory operations are now handled directly by the memory package
// Use the memory package directly instead of these SQLCClient methods

/*
// CreateMemoryEntry creates a new memory entry (DEPRECATED)
func (c *SQLCClient) CreateMemoryEntry(ctx context.Context, entry *MemoryEntryDomain) (*MemoryEntryDomain, error) {
	return nil, fmt.Errorf("CreateMemoryEntry is deprecated - use memory package directly")
}

// GetMemoryEntriesByUser retrieves memory entries for a user (DEPRECATED)
func (c *SQLCClient) GetMemoryEntriesByUser(ctx context.Context, userID string, memoryTypes []string, limit, offset int) ([]*MemoryEntryDomain, error) {
	return nil, fmt.Errorf("GetMemoryEntriesByUser is deprecated - use memory package directly")
}
*/
