...
type AddFavoriteToolRow struct {
	ID          pgtype.UUID `json:"id"`
...
func (q *Queries) AddFavoriteTool(ctx context.Context, arg AddFavoriteToolParams) (*AddFavoriteToolRow, error) {
	row := q.db.QueryRow(ctx, AddFavoriteTool, arg.ID, arg.Column2)
	var i AddFavoriteToolRow
	err := row.Scan(
		&i.ID,
		&i.Username,
		&i.Email,
...
type RemoveFavoriteToolRow struct {
	ID          pgtype.UUID `json:"id"`
	Username    string      `json:"username"`
	Email       string      `json:"email"`
	FullName    pgtype.Text `json:"full_name"`
...
func (q *Queries) RemoveFavoriteTool(ctx context.Context, arg RemoveFavoriteToolParams) (*RemoveFavoriteToolRow, error) {
	row := q.db.QueryRow(ctx, RemoveFavoriteTool, arg.ID, arg.Column2)
	var i RemoveFavoriteToolRow
	err := row.Scan(
		&i.ID,
		&i.Username,
		&i.Email,
