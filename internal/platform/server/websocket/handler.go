...
func (h *HTTPHandler) RegisterRoutes(mux *http.ServeMux) {
	...
	// WebSocket 串流端點
	mux.HandleFunc("GET /ws/stream", h.handleStreamingWebSocket)
...
func (h *HTTPHandler) handleStreamingWebSocket(w http.ResponseWriter, r *http.Request) {
	// 使用串流端點處理
	h.streamEndpoint.ServeHTTP(w, r)
}
