...
func (t *DockerTool) Parameters() *tools.ToolParametersSchema {
	return &tools.ToolParametersSchema{
		...
		Properties: map[string]tools.ToolParameter{
			...
			"options": {
				Type:        tools.ParameterTypeObject,
...
func (t *DockerTool) Execute(ctx context.Context, input *tools.ToolInput) (*tools.ToolResult, error) {
	startTime := time.Now()
