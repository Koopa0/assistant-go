-- Fixed Seed Data for Assistant System
...
-- 1. 建立管理員使用者 Koopa
-- 密碼: koopa123 (實際使用時需要正確的 bcrypt hash)
...
('a4000000-0000-4000-8000-000000000001'::uuid, 'a0000000-0000-4000-8000-000000000001'::uuid, 'preference', 
 'Koopa 偏好使用 Go 語言進行後端開發，特別擅長微服務架構', 0.9,
 '{"source": "conversation_analysis", "confidence": 0.95, "tags": ["go", "microservices", "backend"]}'::jsonb),

('a4000000-0000-4000-8000-000000000002'::uuid, 'a0000000-0000-4000-8000-000000000001'::uuid, 'knowledge', 
...
('a4000000-0000-4000-8000-000000000003'::uuid, 'a0000000-0000-4000-8000-000000000001'::uuid, 'context', 
